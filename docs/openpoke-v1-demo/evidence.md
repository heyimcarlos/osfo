...
| Concurrent authenticated devices at target | No selected load lane combines target traffic with 2 to 4 live device streams per account | MISSING | Required three-tab proof is indexed as `MISSING`. |
