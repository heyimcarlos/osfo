---
name: verify-osfo
description: Verify Osfo registration, SMS phone authentication, Telegram or WhatsApp channel linking, Research Reports, Document Build, immediate Gmail send, Scheduled Email, Reminder Approval and due delivery, billing, permanent account deletion, or retained deletion replay in Chrome with a disposable verified User, local provider boundaries, committed state, and durable evidence. Use after implementing or reviewing one of those browser paths.
---
...
```sh
FEATURE=registration # registration, channel-linking, research-report, document-build-free-denial, document-build, immediate-gmail-send, scheduled-email, billing, whatsapp-wakeup, account-deletion, or account-deletion-replay
