...
const Binding = Schema.Struct({
  ...
  BROWSER_HOST_TOKEN: Schema.String.check(Schema.isMinLength(32), Schema.isMaxLength(512)),
...
await Bun.write(configPath, JSON.stringify({ ...config, vars: { ...config.vars, ...binding } }, null, 2) + "\n");
