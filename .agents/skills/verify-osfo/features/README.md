...
- [Inspect Free billing](billing.md) is the highest-value adjacent authenticated path. The local harness proves the visible Free Plan and may qualify Checkout creation, but the hosted Stripe page remains outside the local browser run.
