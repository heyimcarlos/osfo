# Ephemeral interactive UI generated from an Oz conversation

Date captured: 2026-08-08
Horizon: after v2, not launch scope

Oz could complement conversation with a temporary, authenticated interactive
...
structured result. Oz would create a task-specific UI, send the user a private
...
The long-term version could live directly inside a future Oz chat application.
The nearer technical approximation could launch from WhatsApp into a private
web surface bound to the user's Oz Account and the originating task.
