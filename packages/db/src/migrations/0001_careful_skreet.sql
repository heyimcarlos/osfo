...
CREATE TABLE "channel_link_invites" (
	...
	CONSTRAINT "channel_link_invites_token_hash_check" CHECK ("channel_link_invites"."token_hash" ~ '^[0-9a-f]{64}$'),
...
CREATE UNIQUE INDEX "channel_link_invites_token_hash_unique" ON "channel_link_invites" USING btree ("token_hash");--> statement-breakpoint
