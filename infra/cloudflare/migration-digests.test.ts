  ...
  it.effect("rejects an edited released migration", () =>
    Effect.gen(function* () {
      const mismatch = yield* Effect.flip(
        verifyMigrationDirectory("./apps/worker/src/db/migrations", {
          "20260813224000_redundant_pyro/migration.sql": "edited-digest",
        }),
      );
      ...
      expect(mismatch).toMatchObject({
        ...
        directory: "./apps/worker/src/db/migrations",
      });
    }),
  );
});
