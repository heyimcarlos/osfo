...
export default defineConfig({
  test: {
    include: [
      ...
      "test/production-qualification.test.ts",
      "test/qualification-harness.test.ts",
      "test/qualification-runs.test.ts",
      ...
      "test/semantic-evidence.test.ts",
      "test/stage-evidence.test.ts",
