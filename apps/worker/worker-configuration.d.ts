/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 15e962b1123688cb85c468d57701fc39)
// Runtime types generated with workerd@1.20260826.1 2026-08-12 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
  ...
  EXECUTION_UNIT_WORKFLOW: Workflow<
    Parameters<import("./src/worker").ExecutionUnitWorkflow["run"]>[0]["payload"]
  >;
  RESEARCH_REPORT_WORKFLOW: Workflow<
    Parameters<import("./src/worker").ResearchReportWorkflow["run"]>[0]["payload"]
  >;
  RESEARCH_REPORT_TIMER_WORKFLOW: Workflow<
    Parameters<import("./src/worker").ResearchReportTimerWorkflow["run"]>[0]["payload"]
  >;
  DOCUMENT_BUILD_WORKFLOW: Workflow<
    Parameters<import("./src/worker").DocumentBuildWorkflow["run"]>[0]["payload"]
  >;
  DOCUMENT_BUILD_TIMER_WORKFLOW: Workflow<
    Parameters<import("./src/worker").DocumentBuildTimerWorkflow["run"]>[0]["payload"]
  >;
  SCHEDULED_EMAIL_WORKFLOW: Workflow<
    Parameters<import("./src/worker").ScheduledEmailWorkflow["run"]>[0]["payload"]
  >;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./src/worker");
    durableNamespaces: "OsfoAgent" | "Sandbox" | "OsfoDirectory";
  }
