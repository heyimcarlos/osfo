/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a9ef1a7d7c0a1f86d6e9b213fdf5becb)
// Runtime types generated with workerd@1.20260811.1 2026-08-12 nodejs_compat
interface __BaseEnv_Env {
  DIRECTORY_DB: D1Database;
  ERASURE_RECEIPTS_DB: D1Database;
  OSFO_STAGE: "test";
  OSFO_AGENT: DurableObjectNamespace<import("./src/worker").OsfoAgent>;
  REGISTRATION_DIALOGUE: DurableObjectNamespace<import("./src/worker").RegistrationDialogue>;
...
declare namespace Cloudflare {
  interface GlobalProps {
    ...
    durableNamespaces: "OsfoAgent" | "RegistrationDialogue";
  }
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OSFO_STAGE">> {}
}
