...
const publicBoundaryPolicy = {
  ...
  cleanupHostedBrowsers: ["cancellationReconciliationDeletion", "none"],
  ...
  listBrowserTasks: ["read", "accountDeletionFence"],
  ...
  onFiberRecovered: ["ordinaryMutation", "accountDeletionFence"],
  ...
  openBrowserTask: ["ordinaryMutation", "accountDeletionFence"],
  ...
  resumeBrowserTask: ["ordinaryMutation", "accountDeletionFence"],
...
const directoryBoundaryPolicy = {
  ...
  deliverBrowserApprovalReply: ["ordinaryMutation", "directoryGate"],
  ...
  // Registered-facet browser controls recheck the actor and enter the Agent's tracked fence.
  listBrowserTasks: ["read", "accountDeletionFence"],
  openBrowserTask: ["ordinaryMutation", "accountDeletionFence"],
  resumeBrowserTask: ["ordinaryMutation", "accountDeletionFence"],
