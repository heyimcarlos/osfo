  ...
  if ("growthCorpora" in manifest) {
    ...
    if (
      ...
      const splitEvidenceInvalid =
        ...
        qualificationChecksum(
          EffectArray.sortWith(observedSplitIdentities, (identity) => identity, Order.String),
        ) !==
          qualificationChecksum(
            EffectArray.sortWith(expectedSplitIdentities, (identity) => identity, Order.String),
          ) ||
