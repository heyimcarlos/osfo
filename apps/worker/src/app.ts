  ...
  OSFO_DIRECTORY: {
    getByName: () => {
      ...
      return {
        ...
        deleteAgent: (agentId, userId) => directory.deleteAgent(agentId, userId),
        ...
        inspectImmediateGmailSends: (agentId, actor) =>
          directory.inspectImmediateGmailSends(agentId, actor),
